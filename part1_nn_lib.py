...
class SigmoidLayer(Layer):
    ...
    def forward(self, x):
        ...
        self._cache_current = sigmoid_output
    ...
    def backward(self, grad_z):
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        sigmoid_grad = self._cache_current * (1 - self._cache_current)
...
class ReluLayer(Layer):
    ...
    def forward(self, x):
        ...
        # Store intermediate values for backward pass
        self._cache_current = (x > 0).astype(float)
    ...
    def backward(self, grad_z):
        ...
        grad_x = grad_z * self._cache_current
...
class MultiLayerNetwork(object):
    ...
    def __init__(self, input_dim, neurons, activations):
        ...
        for i, n_out in enumerate(neurons):
...
class Trainer(object):
    ...
    def train(self, input_dataset, target_dataset):
        ...
        for epoch in range(self.nb_epoch):
            ...
            for start_idx in range(0, len(input_dataset), self.batch_size):
                end_idx = min(start_idx + self.batch_size, len(input_dataset))
